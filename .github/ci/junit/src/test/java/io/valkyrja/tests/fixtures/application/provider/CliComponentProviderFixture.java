...
public final class CliComponentProviderFixture implements ComponentProviderContract {
    ...
    public List<ServiceProviderContract> getContainerProviders(ApplicationContract app) {
        return List.of(new CliContainerDataProviderFixture(), new CliRoutingDataProviderFixture());
    }
    ...
    public List<CliRouteProviderContract> getCliProviders(ApplicationContract app) {
        return List.of(new CliRouteProviderFixture());
    }
