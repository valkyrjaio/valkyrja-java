...
/**
 * Annotated controller exercising a matrix of dynamic-route parameter types and modifiers,
 * so the annotation construction path can be asserted to produce the same regex as direct
 * construction.
 */
