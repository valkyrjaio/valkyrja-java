...
package io.valkyrja.fixtures.application.entry;
 ...
 * test.
 */
public final class WorkerHttpProbe {
     ...
     */
    public static WorkerHttpProbe bind(ApplicationContract app) {
        WorkerHttpProbe probe = new WorkerHttpProbe();
