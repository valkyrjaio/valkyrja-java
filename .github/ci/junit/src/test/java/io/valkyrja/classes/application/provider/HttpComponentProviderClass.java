...
/** Test component provider supplying HTTP container and route providers. */
public final class HttpComponentProviderClass implements ComponentProviderContract {
    ...
    public List<ServiceProviderContract> getContainerProviders(ApplicationContract app) {
        return List.of(new HttpContainerDataProviderClass(), new HttpRoutingDataProviderClass());
    }
    ...
    public List<HttpRouteProviderContract> getHttpProviders(ApplicationContract app) {
        return List.of(new HttpRouteProviderClass());
    }
}