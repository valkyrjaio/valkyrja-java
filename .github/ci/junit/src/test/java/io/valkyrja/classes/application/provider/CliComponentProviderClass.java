...
/** Test component provider supplying CLI container and route providers. */
public final class CliComponentProviderClass implements ComponentProviderContract {
    ...
    public List<ServiceProviderContract> getContainerProviders(ApplicationContract app) {
        return List.of(new CliContainerDataProviderClass(), new CliRoutingDataProviderClass());
    }
