...
public class HttpRoutingCliComponentProvider extends ComponentProvider {
    ...
    public List<ServiceProviderContract> getContainerProviders(ApplicationContract app) {
        return List.of(new HttpRoutingCliServiceProvider());
    }
    ...
    public List<CliRouteProviderContract> getCliProviders(ApplicationContract app) {
        return List.of(new HttpRoutingCliRouteProvider());
    }
