...
public interface ProvidersAwareContract {
    ...
    /**
     * Determine whether a publish callback is registered for a type.
     *
     * @param id the provided type
     * @return true when a callback is registered, whether or not it has run
     */
